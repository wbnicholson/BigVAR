...
VARXCons <- function(Y1, X1, k, p, m, s, oos = FALSE, contemp = FALSE) {
    .Call('BigVAR_VARXCons', PACKAGE = 'BigVAR', Y1, X1, k, p, m, s, oos, contemp)
}

ARFitVARXR <- function(K21, k, p, m, s) {
    .Call('BigVAR_ARFitVARXR', PACKAGE = 'BigVAR', K21, k, p, m, s)
}

ICX <- function(Y1, X1, k, pmax, smax, m, pen, h = 1L) {
    .Call('BigVAR_ICX', PACKAGE = 'BigVAR', Y1, X1, k, pmax, smax, m, pen, h)
}
